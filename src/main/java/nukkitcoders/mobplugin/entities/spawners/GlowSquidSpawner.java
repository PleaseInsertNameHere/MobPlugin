...
import nukkitcoders.mobplugin.entities.animal.swimming.GlowSquid;
import nukkitcoders.mobplugin.entities.autospawn.AbstractEntitySpawner;

public class GlowSquidSpawner extends AbstractEntitySpawner {

    public GlowSquidSpawner(AutoSpawnTask spawnTask) {
        super(spawnTask);
    }
